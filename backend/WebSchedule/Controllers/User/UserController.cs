...
namespace WebSchedule.Controllers.User
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [Authorize]
#endif
        public async Task<ActionResult> UpdateLogin([FromBody] UpdateUserLoginCommand command)
        {
            try
            {
                var userId = JwtHelper.GetUserIdFromToken(Request.Headers.Authorization)
        ...
        [Authorize]
#endif
        public async Task<ActionResult> UpdateDisplayName([FromBody] UpdateUserDisplayNameCommand command)
        {
            try
            {
                var userId = JwtHelper.GetUserIdFromToken(Request.Headers.Authorization)
